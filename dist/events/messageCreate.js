    ...
    if (message.content.toLowerCase() === '!stats' || message.content.toLowerCase() === '!info') {
        ...
        try {
            ...
            const embed = new discord_js_1.EmbedBuilder()
                ...
                .setColor('#00ff00')
                .addFields({ name: 'Total People / จำนวนคนซื้อ', value: `${uniqueUsers} คน`, inline: true }, { name: 'Total Keys / จำนวน Key', value: `${totalKeys} คีย์`, inline: true }, { name: 'Customer List / รายชื่อลูกค้า (เจ้าของดิส)', value: userListText || 'ยังไม่มีลูกค้า' })
                .setTimestamp();
